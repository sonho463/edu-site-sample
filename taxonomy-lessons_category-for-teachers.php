		...
		<div class="ly_main">
			...
			<section class="bl_searchUnit">
				<section class="bl_search">
					<div class="bl_search_inner">
						<form class="bl_search_inputBox">
							<input class="bl_search_inputArea" type="text" placeholder="キーワードを入力して検索">
							<button class="bl_search_inputBtn" type="submit"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/search-dl/ico-search.svg" alt=""></button>
						</form>
					</div>
				</section>
			</section>
			...
			<section id="tab_top" class="bl_tabNav">
				<ul id="bl_tabNav_tab" class="bl_tabNav_inner">
					<a href="<?php echo home_url(); ?>/lessons#tab_top" id="all_tab" class="bl_tabNav_item">
						<p>すべての授業</p>
					</a>
					<a href="<?php echo home_url(); ?>/lessons_category/for-students#tab_top" id="for_students_tab" class="bl_tabNav_item">
						<p>生徒に教える</p>
					</a>
					<a href="<?php echo home_url(); ?>/lessons_category/for-teachers#tab_top" id="learn_teaching_tab" class="bl_tabNav_item current_tab">
						<p>教え方を学ぶ</p>
					</a>
				</ul>
			</section>
